...
class AntV2():
    ...
    def update_sfc(self):
        if self.sfc.finished is False:
            self.sfc.path.extend(self.path)
            self.sfc.vnf_location.extend(self.vnf_location)
    ...
    def __repr__(self) -> str:
        return f'Ant {self.id} | SFC {self.sfc.id} | Route: {self.path} | VNF location: {self.vnf_location} | Finished: {self.finished}'
