...
from pymoo.operators.crossover.vnfcrossover import VNFcx
from pymoo.operators.mutation.vnfmutation import VNFmutation
from pymoo.operators.sampling.rnd import VNFRandomSampling
...
class MOEAD(LoopwiseAlgorithm, GeneticAlgorithm):
    ...
    def __init__(self,
                 ...
                 sampling=VNFRandomSampling(),
                 crossover=VNFcx(),
                 mutation=VNFmutation(),
